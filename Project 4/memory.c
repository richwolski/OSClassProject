...
void *initUserProcess() {
    ...
    firstProcess = createNewProcess();
    firstProcess->fileDesc[0] = newIO_FD(0);
    firstProcess->fileDesc[1] = newIO_FD(1);
    firstProcess->fileDesc[2] = newIO_FD(2);
...
PCB *createNewProcess() {
    ...
    memset(newPCB->fileDesc, 0, 256 * sizeof(int *));
